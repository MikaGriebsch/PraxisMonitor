"""
Django settings for PraxisMonitor project.
...
SECRET_KEY = 'django-insecure-^+)bsthwo#p45+bg!2e-&qn5=bj_)%a&2veopm)u!o+h_&#1=w'
...
ROOT_URLCONF = 'PraxisMonitor.urls'
...
WSGI_APPLICATION = 'PraxisMonitor.wsgi.application'
...
JAZZMIN_SETTINGS = {
    ...
    "icons": {
        ...
        "monitor.Media": "fa-solid fa-photo-film",
    },
